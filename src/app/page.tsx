...
function page() {
  ...
  return (
    <div className='p-4 max-w-7xl mx-auto'>
      <Input value={values} onChange={(e)=>setValues(e.target.value)} className='mb-4'>
      </Input>
      <Button disabled={createMessage.isPending} onClick={()=> createMessage.mutate({value: values})}>
